...
app.get('/angular-weather-widget.js', function(req, res) {
	res.sendFile('angular-weather-widget.js', {root: root + '/dist'});
});

app.get('/angular-weather-widget.css', function(req, res) {
	res.sendFile('angular-weather-widget.css', {root: root + '/dist'});
});
